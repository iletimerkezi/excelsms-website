...
const config = {
  title: 'Ücretsiz Excel SMS Eklentisi - İleti Merkezi',
  tagline: 'Excel SMS eklentisi, kullanıcılarımıza daha kaliteli bir müşteri deneyimi sunmak için tasarlanmıştır. Hemen deneyin.',
  url: 'https://www.excelsmseklentisi.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  projectName: 'excelsms-website', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `excelsmseklentisi.com SMS T.C. Bilgi Teknolojileri ve İletişim Kurumu (BTK) tarafından yetkilendirilmiş işletmeci olan eMarka İletişim ve Bilgi Teknolojileri A.Ş. ye ait bir markadır.`,
      },
      prism: {
