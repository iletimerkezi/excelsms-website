...
async function sendEmail(form) {
  ...
  let trContent = `
    ...
    <br />
    <br />
    Excel eklentisini indirmek için <a href="https://www.iletimerkezi.com/programs/iletimerkezi_excel.exe">tıklayınız.</a>
    <br />
    <br />
  ...
  let enContent = `
    ...
    <br />
    <br />
    Click <a href="https://www.iletimerkezi.com/programs/iletimerkezi_excel.exe">to download the Excel add-in.</a>
    <br />
    <br />
  ...
  let trSubject = 'Excel SMS Eklenti Kurulum Bilgileri';
  let enSubject = 'Excel SMS Addon Setup Information';
  ...
  return fetch(new Request('https://api.mailchannels.net/tx/v1/send', {
    method: 'POST',
      ...
      body: JSON.stringify({
        ...
        from: {
          email: 'no-reply@excelsmseklentisi.com',
          name: 'Excel SMS',
        },
